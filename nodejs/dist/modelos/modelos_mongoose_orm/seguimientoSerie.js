...
const SeguimientoSerieSchema = new mongoose_1.Schema({
    idUsuario: { type: mongoose_1.Schema.Types.ObjectId, ref: "Usuario", required: true },
...
exports.default = mongoose_1.default.model("SeguimientoSerie", SeguimientoSerieSchema);
